    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        binde = [
          ...
          "CTRL, XF86MonBrightnessUp, exec, hyprctl hyprsunset temperature $(( $(hyprctl hyprsunset temperature) < 6500 ? $(hyprctl hyprsunset temperature) + 100 : 6500 )); pkill -RTMIN+1 waybar"
          "CTRL, XF86MonBrightnessDown, exec, hyprctl hyprsunset temperature $(($(hyprctl hyprsunset temperature) - 100))); pkill -RTMIN+1 waybar"
        ];
