...
#define COLOR(hex) {((hex >> 24) & 0xFF) / 255.0f, \
                    ...
                    ((hex >> 8) & 0xFF) / 255.0f, \
                    (hex & 0xFF) / 255.0f }
static const float rootcolor[] = COLOR(0x2d2d2dff);
static const float bordercolor[] = COLOR(0x2d2d2dff);
static const float focuscolor[] = COLOR(0xb8b8b8ff);
static const float urgentcolor[] = COLOR(0xb8b8b8ff);
