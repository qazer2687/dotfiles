...
static const MonitorRule monrules[] = {
	...
	*/
	/* defaults */
    {"eDP-1", 0.5, 1, 2, &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL, 0, 0, 2560, 1664, 60, 0, 0},
...
static const char *loveit_cmd[] = { "/home/anriha/.local/bin/loveit-fm.py", NULL };
...
static const Key keys[] = {
    ...
    { MODKEY, 					 	XKB_KEY_m, 						spawn, 				{.v = loveit_cmd}},
